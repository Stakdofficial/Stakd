...
// Second pathway, used only to prove the mechanism on a route LayerZero actively runs on
// testnet. Robinhood testnet has only 5 DVNs and is not indexed by LayerZero Scan; Robinhood
// MAINNET has 14 DVNs and is the real production target.
...
// Token-2022 accounts carry the TransferFeeAmount extension, so they need more rent than SPL's 2039280
const SPL_TOKEN_ACCOUNT_RENT_VALUE = 3000000 // This figure represents lamports (https://solana.com/docs/references/terminology#lamport) on Solana. Read below for more details.
/*
...
export default async function () {
    ...
    return {
        contracts: [{ contract: robinhoodContract }, { contract: solanaContract }],
        connections,
    }
}
